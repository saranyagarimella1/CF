...
public class JPAConfig {
	...
	// This file setup is similar to the persistence.xml we used in Persistence project.
	//Just a different way of representation because there is no main function used here
	@Bean
	public LocalContainerEntityManagerFactoryBean createEmf(){
		
		LocalContainerEntityManagerFactoryBean emf = new LocalContainerEntityManagerFactoryBean();
		emf.setJpaVendorAdapter(new EclipseLinkJpaVendorAdapter());
		emf.setPackagesToScan("io.saranya.CinemaFlix.api.entity");
	...
	private Properties jpaProperties() {
		...
		prop.setProperty(PersistenceUnitProperties.WEAVING, "false"); //weaving or lazy weaving results in not loading all files until asked for the files. So disabling it
